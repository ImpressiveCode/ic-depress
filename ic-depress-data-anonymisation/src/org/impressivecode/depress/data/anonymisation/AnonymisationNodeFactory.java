...
/**
 * <code>NodeFactory</code> for the "Anonymisation" Node.
 ...
 * @author Artur Bilski
 */
public class AnonymisationNodeFactory 
        extends NodeFactory<AnonymisationNodeModel> {
     ...
     */
    @Override
    public NodeView<AnonymisationNodeModel> createNodeView(final int viewIndex,
            final AnonymisationNodeModel nodeModel) {
