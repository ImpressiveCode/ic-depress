 ...
 * 
 */
public class EncryptionNodeModel extends NodeModel {
    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] data, final ExecutionContext exec) throws Exception {
        ...
        ColumnEncryptorTransformer encryptor = createColumnEncrypter(data[0].getDataTableSpec());
    ...
    private ColumnEncryptorTransformer createColumnEncrypter(final DataTableSpec spec) {
        ...
        final ColumnEncryptorTransformer transfomer = new ColumnEncryptorTransformer(spec, encrypts);
        return transfomer;
    }
