 ...
 */
public class EstimationScoreMetricNodePlugin extends Plugin {
    // The shared instance.
    private static EstimationScoreMetricNodePlugin plugin;

    /**
     * The constructor.
     */
    public EstimationScoreMetricNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static EstimationScoreMetricNodePlugin getDefault() {
        return plugin;
    }
