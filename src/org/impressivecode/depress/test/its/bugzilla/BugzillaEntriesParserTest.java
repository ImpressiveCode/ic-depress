 ...
 */
package org.impressivecode.depress.test.its.bugzilla;
...
public class BugzillaEntriesParserTest {
    ...
    private void assertEntry(final ITSDataType its) {
        ...
        assertThat(its.getCreated().toString()).isEqualTo("Thu Dec 10 23:11:00 CET 2009"); // 2009-12-10
                                                                                           // 14:11:00
                                                                                           // -0800
        ...
        assertThat(its.getResolved().toString()).isEqualTo("Sat Aug 14 10:35:59 CEST 2010"); // 2010-08-14
                                                                                             // 01:35:59
                                                                                             // -0700
                                                                                             // delta_ts
        ...
        assertThat(its.getCommentAuthors()).containsOnly("bent.mozilla", "jorendorff", "jst", "samuel.sidler+old",
                "dveditz", "hskupin", "dolske");
    }
