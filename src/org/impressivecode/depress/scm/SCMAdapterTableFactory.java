...
public class SCMAdapterTableFactory {
    ...
    public static final DataColumnSpec AUTHOR_COLSPEC = new DataColumnSpecCreator(AUTHOR_COLNAME, StringCell.TYPE).createSpec();
    ...
    public static final DataColumnSpec EXTENSION_COLSPEC = new DataColumnSpecCreator(EXTENSION_COLNAME, StringCell.TYPE).createSpec();

    public static final DataColumnSpec DATE_COLSPEC = new DataColumnSpecCreator(DATE_COLNAME, DateAndTimeCell.TYPE).createSpec();

    public static final DataColumnSpec MESSAGE_COLSPEC = new DataColumnSpecCreator(MESSAGE_COLNAME, StringCell.TYPE).createSpec();
    ...
    public static DataTableSpec createDataColumnSpec() {
        DataColumnSpec[] allColSpecs = { RESOURCE_COLSPEC, EXTENSION_COLSPEC, AUTHOR_COLSPEC,
