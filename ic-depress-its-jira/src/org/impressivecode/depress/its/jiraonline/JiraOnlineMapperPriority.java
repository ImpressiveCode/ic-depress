 ...
 * 
 */
public class JiraOnlineMapperPriority extends JiraOnlineMapperAbstractCustomField {

    public JiraOnlineMapperPriority(List<JiraOnlineFilterListItem> fieldList) {
        super(fieldList);
    }
