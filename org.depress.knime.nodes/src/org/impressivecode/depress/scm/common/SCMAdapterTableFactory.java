...
public class SCMAdapterTableFactory {
    ...
    public static DataRow createTableRow(final String rowId, final SCMDataType scmData) {
        assertData(scmData);
        DataCell[] cells = { stringCell(scmData.getResourceName()), stringOrMissingCell(scmData.getExtension()),
                stringOrMissingCell(scmData.getAuthor()), stringCell(scmData.getOperation()),
