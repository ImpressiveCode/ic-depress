 ...
 */
public class JiraOfflineAdapterNodeModel extends ITSOfflineNodeModel {

    protected JiraOfflineAdapterNodeModel() {
        super();
    }
    ...
    private List<ITSDataType> parseEntries(final String filePath) throws ParserConfigurationException, SAXException,
        ...
        return new JiraOfflineEntriesParser(mappingManager.getPriorityModel().getIncluded(), mappingManager.getTypeModel()
    ...
    protected DataTableSpec[] configure(final DataTableSpec[] inSpecs) throws InvalidSettingsException {
        ...
        return JiraOfflineAdapterTableFactory.createTableSpec();
    }
