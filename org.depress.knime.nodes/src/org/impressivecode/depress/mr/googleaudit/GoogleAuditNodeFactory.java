...
public class GoogleAuditNodeFactory extends NodeFactory<GoogleAuditNodeModel> {
    ...
    @Override
    public GoogleAuditNodeModel createNodeModel() {
        return new GoogleAuditNodeModel();
    }
    ...
    @Override
    public NodeView<GoogleAuditNodeModel> createNodeView(final int viewIndex, final GoogleAuditNodeModel nodeModel) {
    ...
    public NodeDialogPane createNodeDialogPane() {
        return new GoogleAuditNodeDialog();
    }
