 ...
 * @author PWr team
 */
public class SvnPluginNodePlugin extends Plugin {
    // The shared instance.
    private static SvnPluginNodePlugin plugin;

    /**
     * The constructor.
     */
    public SvnPluginNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SvnPluginNodePlugin getDefault() {
        return plugin;
    }
