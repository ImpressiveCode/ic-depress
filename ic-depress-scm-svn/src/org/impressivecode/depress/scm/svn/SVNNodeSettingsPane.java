...
public class SVNNodeSettingsPane extends NodeDialogPane {


    /* The tabs' names. */
    private static final String OPTIONS_TAB_TITLE = "Options";
    ...
    protected DialogComponentString packageChoice;
     ...
     */
    public SVNNodeSettingsPane() {
        super();
        m_dialogComponents = new ArrayList<DialogComponent>();
        
        super.addTab(OPTIONS_TAB_TITLE, optionsPanel());
        super.addTab(ADVANCED_TAB_TITLE, advancedPanel());
    }
    ...
    protected Component createPackageComponent(){

    	packageChoice = new DialogComponentString(new SettingsModelString(
                SVNOfflineAdapterNodeModel.CFG_PACKAGENAME, SVNOfflineAdapterNodeModel.PACKAGENAME_DEFAULT),
                "Package prefix: ");

        return packageChoice.getComponentPanel();
    }
