...
public class SCMAdapterTableFactory {
    ...
    public static final String EXTENTION_COLNAME = "Extention";
    public static final DataColumnSpec EXTENTION_COLSPEC = new DataColumnSpecCreator(EXTENTION_COLNAME, StringCell.TYPE)
    .createSpec();
    ...
    public static DataTableSpec createDataColumnSpec() {
        DataColumnSpec[] allColSpecs = { RESOURCE_COLSPEC, EXTENTION_COLSPEC, AUTHOR_COLSPEC,
    ...
    public static DataRow createTableRow(final String rowId, final SCMDataType scmData) {
        assertData(scmData);
        DataCell[] cells = { stringCell(scmData.getResourceName()), stringCell(scmData.getExtention()), stringOrMissingCell(scmData.getAuthor()),
