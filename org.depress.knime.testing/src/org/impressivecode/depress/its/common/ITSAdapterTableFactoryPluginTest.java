...
import static org.impressivecode.depress.its.common.ITSAdapterTableFactory.ISSUE_ID;
import static org.impressivecode.depress.its.common.ITSAdapterTableFactory.RESOLVED_DATE;
import static org.impressivecode.depress.its.common.ITSAdapterTableFactory.SUMMARY;
import static org.impressivecode.depress.its.common.ITSAdapterTableFactory.UPDATED_DATE;
...
public class ITSAdapterTableFactoryPluginTest {

    @Test
    public void shouldCreateITSTableSpec() {
        DataTableSpec spec = createDataColumnSpec();
        assertThat(spec.getNumColumns()).isEqualTo(21);
    }
