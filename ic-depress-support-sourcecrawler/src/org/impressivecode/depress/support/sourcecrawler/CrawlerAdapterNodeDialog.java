...
public class CrawlerAdapterNodeDialog extends DefaultNodeSettingsPane {
    ...
    private final DialogComponentButtonGroup radioButton = new DialogComponentButtonGroup(
            CrawlerAdapterNodeModel.createRadioSettings(), null, false, CrawlerAdapterNodeModel.actions,
            CrawlerAdapterNodeModel.actions);
    private final DialogComponentFileChooser fileChooser = new DialogComponentFileChooser(
            CrawlerAdapterNodeModel.createFileSettingsXML(), HISTORY_ID_XML, JFileChooser.OPEN_DIALOG, false,
            FILE_EXTENSION);
    private final DialogComponentFileChooser directoryChooser = new DialogComponentFileChooser(
            CrawlerAdapterNodeModel.createFileSettingsDIR(), HISTORY_ID_DIR, JFileChooser.OPEN_DIALOG, true);
    ...
    private void createAdvancedTab() {
        ...
        addDialogComponent(createBooleanComponent(CrawlerAdapterNodeModel.PUBLIC,
                CrawlerAdapterNodeModel.PUBLIC_CONFIG, true, booleanComponentWidth, booleanComponentHeight));
        addDialogComponent(createBooleanComponent(CrawlerAdapterNodeModel.PRIVATE,
                CrawlerAdapterNodeModel.PRIVATE_CONFIG, true, booleanComponentWidth, booleanComponentHeight));
        addDialogComponent(createBooleanComponent(CrawlerAdapterNodeModel.PROTECTED,
                CrawlerAdapterNodeModel.PROTECTED_CONFIG, true, booleanComponentWidth, booleanComponentHeight));
        addDialogComponent(createBooleanComponent(CrawlerAdapterNodeModel.PACKAGE,
                CrawlerAdapterNodeModel.PACKAGE_CONFIG, true, booleanComponentWidth, booleanComponentHeight));
        closeCurrentGroup();
        ...
        addDialogComponent(createBooleanComponent(CrawlerAdapterNodeModel.INTERFACE,
                CrawlerAdapterNodeModel.INTERFACE_CONFIG, true, booleanComponentWidth, booleanComponentHeight));
        addDialogComponent(createBooleanComponent(CrawlerAdapterNodeModel.ABSTRACT,
                CrawlerAdapterNodeModel.ABSTRACT_CONFIG, true, booleanComponentWidth, booleanComponentHeight));
        ...
        addDialogComponent(createBooleanComponent(CrawlerAdapterNodeModel.EXCEPTION,
                CrawlerAdapterNodeModel.EXCEPTION_CONFIG, true, booleanComponentWidth, booleanComponentHeight));
        ...
        addDialogComponent(new DialogComponentString(CrawlerAdapterNodeModel.createPackageSettings(), "Package: ",
                false, 40));
        closeCurrentGroup();

        addDialogComponent(createBooleanComponent(CrawlerAdapterNodeModel.CREATE_XML,
                CrawlerAdapterNodeModel.CREATE_XML_CONFIG, false, booleanComponentWidth, booleanComponentHeight));
    }
    ...
    private DialogComponentBoolean createBooleanComponent(final String label, final String configLabel,
        ...
        DialogComponentBoolean component = new DialogComponentBoolean(new SettingsModelBoolean(configLabel,
                defaultValue), label);
