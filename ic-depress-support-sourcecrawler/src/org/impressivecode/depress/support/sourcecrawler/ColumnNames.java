	...
	IS_EXCEPTION("Is exception") {
		...
		public DataColumnSpec getDataColumnCreator() {
			return new DataColumnSpecCreator(
					ColumnNames.IS_EXCEPTION.toString(), StringCell.TYPE)
					.createSpec();
		}
	},
	IS_INNER("Is inner") {
		@Override
		public DataColumnSpec getDataColumnCreator() {
			return new DataColumnSpecCreator(ColumnNames.IS_INNER.toString(),
					StringCell.TYPE).createSpec();
		}
	},
	IS_TEST("Is test") {
		@Override
		public DataColumnSpec getDataColumnCreator() {
			return new DataColumnSpecCreator(ColumnNames.IS_TEST.toString(),
					StringCell.TYPE).createSpec();
		}
	},
	TYPE("Type") {
		@Override
		public DataColumnSpec getDataColumnCreator() {
			return new DataColumnSpecCreator(ColumnNames.TYPE.toString(),
					StringCell.TYPE).createSpec();
		}
	},
	PACKAGE("Package") {
		@Override
		public DataColumnSpec getDataColumnCreator() {
			return new DataColumnSpecCreator(ColumnNames.PACKAGE.toString(),
					StringCell.TYPE).createSpec();
		}
	},
	PATH("Path") {
		@Override
		public DataColumnSpec getDataColumnCreator() {
			return new DataColumnSpecCreator(ColumnNames.PATH.toString(),
					StringCell.TYPE).createSpec();
		}
	};
