 ...
 * 
 */
public class SemanticAnalysisNodeFactory extends NodeFactory<SemanticAnalysisNodeModel> {

    @Override
    public SemanticAnalysisNodeModel createNodeModel() {
        return new SemanticAnalysisNodeModel();
    }
    ...
    public NodeDialogPane createNodeDialogPane() {
        return new SemanticAnalysisNodeDialog();
    }
}
