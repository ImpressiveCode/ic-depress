 ...
 * @author zmwo-proj
 */
public class EndevorParserNodePlugin extends Plugin {
    // The shared instance.
    private static EndevorParserNodePlugin plugin;

    /**
     * The constructor.
     */
    public EndevorParserNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static EndevorParserNodePlugin getDefault() {
        return plugin;
    }
