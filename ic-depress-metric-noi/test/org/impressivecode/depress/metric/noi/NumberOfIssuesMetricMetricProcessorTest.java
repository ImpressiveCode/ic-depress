 ...
 * 
 */
public class NumberOfIssuesMetricMetricProcessorTest {
    ...
    public void shouldComputeMetricWhenIssues() {
        ...
        NumberOfIssuesMetricMetricProcessor noim = new NumberOfIssuesMetricMetricProcessor(issues, changes);
        // when
        List<NoIMetricType> results = noim.computeMetric();
        // then
        assertThat(results).hasSize(2);
        NoIMetricType noiA = Iterables.find(results, new NoiPredicate("ClassA"));
        assertThat(noiA.getIssues()).onProperty("issueId").containsOnly("i1", "i1", "i2");
        NoIMetricType noiB = Iterables.find(results, new NoiPredicate("ClassB"));
    ...
    public void shouldComputeMetricWhenNoIssues() {
        ...
        NumberOfIssuesMetricMetricProcessor noim = new NumberOfIssuesMetricMetricProcessor(
    ...
    private class NoiPredicate implements Predicate<NoIMetricType> {
        ...
        @Override
        public boolean apply(final NoIMetricType noi) {
