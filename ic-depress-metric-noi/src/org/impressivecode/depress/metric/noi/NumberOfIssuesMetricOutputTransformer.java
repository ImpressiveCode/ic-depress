...
import static org.impressivecode.depress.metric.noi.NumberOfIssuesMetricTableFactory.createTableRow;
...
public class NumberOfIssuesMetricOutputTransformer implements OutputTransformer<NoIMetricType> {
    ...
    @Override
    public BufferedDataTable transform(final List<NoIMetricType> data, final ExecutionContext exec)
