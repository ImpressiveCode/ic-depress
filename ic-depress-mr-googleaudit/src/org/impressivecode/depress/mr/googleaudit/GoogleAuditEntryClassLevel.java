 ...
 * 
 */
public class GoogleAuditEntryClassLevel implements GoogleAuditEntry {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null)
            return false;
        if (!(obj instanceof GoogleAuditEntryClassLevel))
            return false;
        GoogleAuditEntryClassLevel other = (GoogleAuditEntryClassLevel) obj;
