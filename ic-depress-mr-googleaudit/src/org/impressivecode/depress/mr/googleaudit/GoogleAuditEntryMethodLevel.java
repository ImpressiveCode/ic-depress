 ...
 * 
 */
public class GoogleAuditEntryMethodLevel implements GoogleAuditEntry {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null)
            return false;
        if (!(obj instanceof GoogleAuditEntryMethodLevel))
            return false;
        GoogleAuditEntryMethodLevel other = (GoogleAuditEntryMethodLevel) obj;
