...
public class ClearQuestReaderNodeDialog extends XLSReaderNodeDialog {
    private static final String MAIN_TAB = "ClearQuest Reader Settings";
    private static final String SECOND_TAB = "Mapping";

    private ArrayList<JComboBox<BasicComboBoxRenderer>> m_columnNames;
    private ClearQuestUserSettings m_settings;

    public ClearQuestReaderNodeDialog() {
        super();
        super.renameTab("XLS Reader Settings", MAIN_TAB);
        Container cqTab = (Container) this.getTab(MAIN_TAB);
        Container secondContainer = (Container) ((Container) ((Container) cqTab.getComponent(0)).getComponent(0))
                .getComponent(1);
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                if (pane.getSelectedIndex() == 1) {
                    try {
                        ...
                        NodeLogger.getLogger(ClearQuestReaderNodeDialog.class).debug("Error while accessing file", t);
                    }
                }
            }
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings, final DataTableSpec[] specs)
        ...
        ClearQuestUserSettings cqs;
        try {
            cqs = ClearQuestUserSettings.load(settings);
        } catch (InvalidSettingsException e) {
            cqs = new ClearQuestUserSettings();
        }
        cqs.setHasColHeaders(true);
    ...
    protected void loadSettingsFrom(NodeSettingsRO settings, PortObjectSpec[] specs) throws NotConfigurableException {
        ...
        try {
            ...
            NodeLogger.getLogger(ClearQuestReaderNodeDialog.class).debug("Error while loading settings", t);
        }
     ...
     */
    @Override
    protected void saveSettingsTo(NodeSettingsWO cqSettings) throws InvalidSettingsException {
        super.saveSettingsTo(cqSettings);
        ...
        cqSettings.addStringArray(ClearQuestUserSettings.ITS_MAPPING, selectedColumns);
    }
