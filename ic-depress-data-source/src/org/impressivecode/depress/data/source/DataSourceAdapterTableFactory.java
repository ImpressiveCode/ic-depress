...
public class DataSourceAdapterTableFactory {
    ...
    public static DataTableSpec createDataColumnSpec() {
        DataColumnSpec[] temp = new DataColumnSpec[12];
        ...
        temp[10] = new DataColumnSpecCreator("Enum", BooleanCell.TYPE).createSpec();
        temp[11] = new DataColumnSpecCreator("Exception", StringCell.TYPE).createSpec();
