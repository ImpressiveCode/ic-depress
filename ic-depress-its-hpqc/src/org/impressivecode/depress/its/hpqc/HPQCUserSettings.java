...
public class HPQCUserSettings {
     ...
     */
    public static HPQCUserSettings load(final NodeSettingsRO settings)
     ...
     */
    public static HPQCUserSettings clone(final HPQCUserSettings orig)
            throws InvalidSettingsException {
        NodeSettings clone = new NodeSettings("clone");
        orig.save(clone);
        return HPQCUserSettings.load(clone);
    }
