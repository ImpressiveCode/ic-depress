 ...
 */
class HPQCIterator extends CloseableRowIterator {

    private static final NodeLogger LOGGER =
            NodeLogger.getLogger(HPQCIterator.class);
     ...
     */
    HPQCIterator(final HPQCTableSettings settings, final Workbook wb)
    ...
    private void setNextRow() {
        ...
        while (true) {
            m_nextRowIdx++;
            if (m_nextRowIdx > HPQCTable.getLastRowIdx(m_currentSheet)) {
